...
public final class IgniteQuickStart {
    ...
    public static void main(String[] args) throws IgniteException {
        ...
        SalesforceConfig salesforceConfig = SalesforceConfig.fromEnv();
        SalesforceClient salesforceClient = new HttpSalesforceClient(salesforceConfig);
        ...
        userCacheCfg.setCacheStoreFactory(new FactoryBuilder.SingletonFactory<>(userCacheStore));
        ...
        SalesforceUserDetails userDetails1 = userCache.get(salesforceConfig.getUserId());
